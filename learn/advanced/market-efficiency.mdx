...
**Eficiencia** (consolidacion, acumulacion, distribucion) **-->** **Ineficiencia** (expansion, displacement, price run) **-->** **Eficiencia** (reequilibrio, el precio "rellena" el vacio). Se repite infinitamente.
