...
<iframe src="https://mrblacksheep91.github.io/innova-trading-docs/charts/diagrams.html?d=interbank-pyramid" style={{width: '100%', height: '360px', border: 'none', borderRadius: '8px'}} />
...
```
  Precio
    │
    │        ╭──╮  ← Spike: bids se secan aquí
    │       ╭╯  ╰╮
    │      ╭╯    ╰╮
    │     ╭╯      ╰──── Retorno a base de liquidez
    │────╯
    │ ← Base de liquidez (volumen estable)
    └───────────────────── Tiempo
```
...
```
  ...
  Cada nivel tiene                 Salto brusco, sin
  transacciones.                   transacciones en el
  El precio "camina".              medio. Vacío de liquidez.
```
